<template>
  <div>
    <div style="display: flex;flex-direction: row;align-items: flex-end;align-items: center;justify-content: center;margin:10px;">
      <div class="bankStyle">WcN银行管理系统</div>
      <a-space direction="vertical" style="width: 300px;margin-left: auto">
        <a-badge-ribbon text="you are teller" color="pink">
...
import registerModal from "../../components/modal/registerUserModal.vue"
import deleteModal from "../../components/modal/deleteModal.vue"
import {userListFuc} from "../../api/adminTable.js";
import {onMounted, ref} from "vue";

const userInfo = ref()

onMounted(async () => {
  const res = await userListFuc()
  console.log(res)
